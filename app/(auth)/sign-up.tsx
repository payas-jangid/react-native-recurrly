...
export default function Page() {
  ...
  const handleSubmit = async () => {
    ...
    setFormError("Unable to continue. Please check your input and try again.");
  };
  ...
  const handleVerify = async () => {
    ...
    if (!code.trim()) {
      setFormError("Enter the verification code we sent to your inbox.");
      return;
    }
    ...
    setFormError("The code did not match. Try again or request a new one.");
  };
      ...
      <View className="auth-content">
        <View className="auth-brand-block">
          ...
          <Text className="auth-subtitle">
            Join Recurly and manage every subscription with confidence. Your
            billing dashboard is one tap away.
          </Text>
        </View>
